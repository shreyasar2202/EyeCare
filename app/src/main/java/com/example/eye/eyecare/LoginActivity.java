package com.example.eye.eyecare;
...
//
    ...
    public void onClick(View view) {
        if (view == buttonSignIn) {
            //userLogin();
            DatabaseReference reference=FirebaseDatabase.getInstance().getReference().child("abc");
            reference.setValue("abc");
            firebaseAuth.createUserWithEmailAndPassword("abc@gmail.com","abcdefgh").addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                @Override
                public void onComplete(@NonNull Task<AuthResult> task) {
